...
<body>
    ...
    <div class="container">
        ...
        <footer>
            <p>Generated by <strong>Inference Lounge</strong> | Fork of <a href="https://github.com/liminalbardo/liminal_backrooms" target="_blank">Liminal Backrooms</a></p>
        </footer>
    </div>
...
class LiminalBackroomsManager:
    """Main manager class for the Inference Lounge application"""
...
def create_gui():
    ...
    if sys.platform == 'win32':
        ...
        app.setApplicationName("Inference Lounge")
